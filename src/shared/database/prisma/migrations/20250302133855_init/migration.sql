...
-- CreateEnum
CREATE TYPE "AppointmentStatus" AS ENUM ('PENDING', 'SCHEDULED', 'CONFIRMED', 'CANCELLED', 'COMPLETED', 'NO_SHOW');
...
-- CreateIndex
CREATE INDEX "appointment_patient_idx" ON "Appointment"("patientId");

-- CreateIndex
CREATE INDEX "appointment_doctor_idx" ON "Appointment"("doctorId");

-- CreateIndex
CREATE UNIQUE INDEX "Payment_appointmentId_key" ON "Payment"("appointmentId");

-- CreateIndex
CREATE INDEX "payment_appointment_idx" ON "Payment"("appointmentId");
...
-- AddForeignKey
ALTER TABLE "Payment" ADD CONSTRAINT "payment_appointment_fkey" FOREIGN KEY ("appointmentId") REFERENCES "Appointment"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
